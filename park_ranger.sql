...
--
-- Host: localhost
-- Generation Time: Feb 12, 2015 at 08:28 PM
...
ALTER TABLE `vote_laporan`
 ADD PRIMARY KEY (`id_laporan`,`voter`), ADD KEY `voter` (`voter`);
...
--
ALTER TABLE `ditanggapi`
ADD CONSTRAINT `ditanggapi_ibfk_1` FOREIGN KEY (`id_laporan`) REFERENCES `pengaduan` (`id_laporan`),
ADD CONSTRAINT `ditanggapi_ibfk_2` FOREIGN KEY (`id_tanggapan`) REFERENCES `tanggapan` (`id_tanggapan`);
...
ADD CONSTRAINT `pengaduan_ibfk_5` FOREIGN KEY (`id_taman`) REFERENCES `taman` (`id_taman`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tanggapan`
ADD CONSTRAINT `tanggapan_ibfk_1` FOREIGN KEY (`id_penanggap`) REFERENCES `pihak_berwenang` (`id_user`);
...
ADD CONSTRAINT `vote_laporan_ibfk_2` FOREIGN KEY (`voter`) REFERENCES `member` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
